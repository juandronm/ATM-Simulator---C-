...
namespace ATMSimulator_1
{
    public partial class CultureBank : Form
    {
        ...
        public CultureBank()
        {
            ...
            string dbPath = Path.Combine(Directory.GetParent(Application.StartupPath).Parent.Parent.FullName, "bankaccounts.accdb");
        ...
        private void CheckButton_Click(object sender, EventArgs e)
        {
            ...
            if (isWaitingToAddNewUser)
            {
                ...
                try
                {
                    ...
                    string insertQuery = "INSERT INTO Clients ([Client No], Funds, [Daily Limit], [Password]) VALUES (?, 0, 0, ?)";
